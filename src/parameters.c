...
//int parameters_kernel_blockNum = 260;
//int parameters_kernel_threadNum = 128;
int4 parameters_batchSize = 60000000; 
int parameters_pthread_threadNum = 1;


char* parameters_queryFile = "";
char* parameters_subjectDatabaseFile = "";
char* mpi_parameters_subjectDatabaseFile = "";
...
void parameters_processArguments(int4 argc, char* argv[])
{
    ...
    {
        //{'B', parameters_INT, &parameters_kernel_blockNum,
        //"Number of blocks in the kernel", "260"},
        //{'T', parameters_INT, &parameters_kernel_blockNum,
     ...
     {'t', parameters_INT, &parameters_pthread_threadNum, 
         "Number of threads for multithreaded gapped extension and alignment", "1"},
     {'s', parameters_INT, &parameters_batchSize, 
         "Batch size of sub sequence from database", "80000000"},
...
void mpi_parameters_processArguments(int rank, int num_procs, int4 argc, char* argv[])
{
	int4 count = 1, value, argumentCount;
	float floatValue;
    double doubleValue;
...
/*     {'I', parameters_BYTE, &parameters_useIndex,
    ...
    mpi_parameters_subjectDatabaseFile = (char*)global_malloc(strlen(parameters_subjectDatabaseFile) + 4);
    sprintf(mpi_parameters_subjectDatabaseFile, "%s.%d", parameters_subjectDatabaseFile, rank);
