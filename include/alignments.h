...
void alignments_findGoodAlignments_multithread(struct PSSMatrix PSSMatrix, struct PSSMatrixFP PSSMatrixFP, int n_threads);
...
void alignments_getTracebacks_multithread(struct PSSMatrix PSSMatrix, struct PSSMatrixFP PSSMatrixFP, int n_threads);
...
extern struct memBlocks* alignments_volumeAlignments[constants_maxNumVolumes];
extern uint4 alignments_numVolumes;
extern int alignments_finalAlignmentsSorted;
extern uint4 alignments_numClusters;
